var Login = function () {
    var e = function () {
        $(".login-form").validate({
            ...
            messages: {username: {required: "用户名不能为空."}, password: {required: "密码不能为空."}},
    ...
    return {
        init: function () {
            e(), r(), s(), $.backstretch(["/Public/assets/pages/media/bg/1.jpg", "/Public/assets/pages/media/bg/2.jpg", "/Public/assets/pages/media/bg/3.jpg", "/Public/assets/pages/media/bg/4.jpg"], {
                fade: 1e3,
                duration: 8e3
            })
        }
