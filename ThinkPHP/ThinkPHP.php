...
defined('__HOST__') or define("__HOST__","http://" . $host);
define('TP_PATH', str_replace('\\','/',dirname(__FILE__)) . '/');
defined('__TP__') || define('__TP__', __HOST__. '/' .trim(str_ireplace(str_replace('\\', '/', $_SERVER['DOCUMENT_ROOT']), '', TP_PATH), '/') );
defined('__TP_EXT__') || define('__TP_EXT__', __TP__.'/Extend');
defined('__TP_EXT_ORG__') || define('__TP_EXT_ORG__', __TP_EXT__.'/Org');
define('XHY_PATH', str_replace('\\','/',dirname(__FILE__)) . '/');
defined('__XHYPHP__') or define("__XHYPHP__", __HOST__ . '/' . trim(str_ireplace(str_replace('\\', '/', $_SERVER['DOCUMENT_ROOT']), "", XHY_PATH), '/'));
defined('__XHYPHP_EXTEND__') or define("__XHYPHP_EXTEND__", __XHYPHP__ . '/Extend');
//xhy stop
