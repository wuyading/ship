...
(function () {
    ...
    if (!window.CKEDITOR)window.CKEDITOR = (function () {
        var a = {timestamp: 'D03G5XL', version: '3.6.6.2', revision: '7696', rnd: Math.floor(Math.random() * 900) + 100, _: {}, status: 'unloaded', basePath: (function () {
    ...
    (function () {
        ...
        j.enterkey = {enterBlock: function (t, u, v, w) {
            ...
            if (!w && z && p.test(C)) {
                ...
                var G;
                D = C == 'pre';
                if (C == 'pre' && c && b.version < 8)G = x.createText('\r'); else G = x.createElement('br');
                v.deleteContents();
                v.insertNode(G);
    ...
    (function () {
        ...
        k.dialog.checkbox.prototype = e.extend(new k.dialog.uiElement(), {getInputElement: function () {
            ...
            if (!c || b.version > 8)return r.onChange.apply(this, arguments); else {
                u.on('load', function () {
