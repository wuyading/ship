...
use Zilf\VarDumper\Dumper\CliDumper;
...
%A  options: []
  ...
  "obj" => Zilf\VarDumper\Tests\Fixture\DumbFoo {#%d
    +foo: "foo"
    +"bar": "bar"
  }
  "closure" => Closure {{$r}
    class: "Zilf\VarDumper\Tests\CliDumperTest"
    this: Zilf\VarDumper\Tests\CliDumperTest {{$r} …}
    parameters: {
      \$a: {}
      &\$b: {
        typeHint: "PDO"
  ...
  8 => &1 null
  "sobj" => Zilf\VarDumper\Tests\Fixture\DumbFoo {#%d}
  "snobj" => &3 {#%d}
  "snobj2" => {#%d}
  "file" => "{$var['file']}"
  b"bin-key-é" => ""
...
%Awrapper_type: "PHP"
  ...
  uri: "php://memory"
%Aoptions: []
  ⚠: Zilf\VarDumper\Exception\ThrowingCasterException {{$r}
