...
use Zilf\VarDumper\Caster\PdoCaster;
use Zilf\VarDumper\Cloner\Stub;
...
class PdoCasterTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCastPdo()
    {
        ...
        $this->assertInstanceOf('Zilf\VarDumper\Caster\EnumStub', $cast["\0~\0attributes"]);

        $attr = $cast["\0~\0attributes"] = $cast["\0~\0attributes"]->value;
        $this->assertInstanceOf('Zilf\VarDumper\Caster\ConstStub', $attr['CASE']);
